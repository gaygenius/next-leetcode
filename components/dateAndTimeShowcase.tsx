...
const DateAndTimeShowcase = ({ date }) => {
...
export default DateAndTimeShowcase;

export const formatLongDateAndTime = (date, locale) =>
  new Intl.DateTimeFormat(locale, formatOptions[0]).format(date);
